    ...
    return (
        <div className={style.topic} data={props.small === true ? "small" : undefined}>
            <div className={style["topic-title-wrapper"]}>
                ...
                {props.items.length < 2 ? null : <div className={style["topic-nav-button"]} onClick={() => { sliderRef.current?.slickPrev(); }}>
                    <div className={style["icon-previous"]} />
                </div>}
                {props.items.length < 2 ? null : <div className={style["topic-nav-button"]} onClick={() => { sliderRef.current?.slickNext(); }}>
